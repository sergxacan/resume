...
var header = {
  ...
  address:
    'Україна, м.Чернівці, вул. Тпрютпрюткевича, 17, кв.27',
}
var footer = {
  social: {
    email: {
...
router.get('/education', function (req, res) {
  ...
  res.render('education', {
    ...
    main: {
      education: [
        { name: 'Чернівецька школа № 23', isEnd: true },
        {
          name: 'Чернівецький національний університет ім. Ю.Федьковича',
          isEnd: true,
        },
        { name: 'КНУКіМ', isEnd: false },
      ],
      certificates: [
        { name: 'Атестат', id: 345 },
        { name: 'Диплом', id: 2337 },
